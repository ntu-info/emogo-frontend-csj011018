...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=21795036&assignment_repo_type=AssignmentRepo)
...
3. Open the app on a device or emulator using the Expo dev tools.
   ...
   ```bash
   https://expo.dev/accounts/b10207074/projects/expo-router-mwe/builds/aa44b9c5-52a5-4e94-a2dd-fc7056d722e4
   ```
